...
--[[
    Render the paddle small by drawing the main texture, passing in the quad
    that corresponds to the proper skin and size.
]]
function Paddle:renderSmall()
    love.graphics.draw(gTextures['main'], gFrames['paddles'][self.skin] ,
        self.x, self.y)
end
--[[
    Render the paddle large by drawing the main texture, passing in the quad
    that corresponds to the proper skin and size.
]]
function Paddle:renderLarge()
    love.graphics.draw(gTextures['main'], gFrames['paddles'][self.size  * (self.skin + 3)],
        self.x, self.y)
end